    ...
    <section className="flex-grow">
      ...
      <div className="flex flex-row gap-8">
        <section className="flex-1">
          <h2 className="text-3xl pb-2 dark:text-white">Departments</h2>
          <hr />
          <ul className="list-disc list-inside">
            {departments.map((department) => (
              <li className="py-1 dark:text-white">{department.department_name}</li>
            ))}
          </ul>
        </section>
        <section className="flex-1">
          <h2 className="text-3xl pb-2 dark:text-white">Locations</h2>
          <hr />
          <ul className="list-disc list-inside">
            {locations.map((location) => (
              <li className="py-1 dark:text-white">{location.location_name}</li>
            ))}
          </ul>
        </section>
      </div>
